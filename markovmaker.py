...
# This script takes a .txt file and makes a mashup of it using a Markov chain: linking word phrases together from different spots in the text.

# For instance, if the text contained two lines,
# "she has a dog" and "my dog has a tail," this might generate "my dog has a dog" and "she has a tail."
import markovgen, re, string

# Choose original file, new filename
original = open('data/harry.txt', 'r', 1, 'utf-8')
outfile = open('data/harry_markov.txt','w')
